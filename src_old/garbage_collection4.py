'''
Garbage Collection MDP v4
State representation: (m_left, o, frag)
    m_left - amount of memory left
    o - binary, whether we're out of memory
    frag - amount of fragmentation, discretized into intervals of 5%
Example: (m_left=6, o=0, frag=6) --[M 16]--> (m_left=6, o=1, frag=6)
'''
import numpy as np
import sys
...
class GarbageCollectionEnv4(object):
